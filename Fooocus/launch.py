...
def fooocusinpaintlaunch(fooocus_dir, image_array, mask_array, performance, checkpoint, positive_prompt, negative_prompt, guidance_scale, image_sharpness, seed, method, inpaint_additional_prompt, outpainting, lora1, lora1_weight, lora2, lora2_weight, lora3, lora3_weight, lora4, lora4_weight, lora5, lora5_weight):
	...
	if outpainting == "Top + Bottom":
		outpainting = ["Top", "Bottom"]
	if outpainting == "Left + Right":
		outpainting = ["Left", "Right"]
	else:
